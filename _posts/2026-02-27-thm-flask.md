...
- [**Task 2: Installation and Deployment basics**] (#task-2-installation-and-deployment-basics)
- [**Task 3: Basic syntax and routing**] (#task-3-basic-syntax-and-routing)
- [**Task 4: HTTP Methods and Template Rendering**] (#task-4-http-methods-and-template-rendering)
- [**Task 6: Flask Injection**] (#task-6-flask-injection)
- [Process:] (#process)
...
<a id="task-2-installation-and-deployment-basics"></a>
...
<a id="task-3-basic-syntax-and-routing"></a>
...
<a id="task-4-http-methods-and-template-rendering"></a>
