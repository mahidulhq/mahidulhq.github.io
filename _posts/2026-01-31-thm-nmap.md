...
date: 2026-01-31 03:28:00 +0600
categories: [writeup]
---

## Index <!-- omit in toc -->
- [**Does the target ip respond to ICMP echo (ping) requests (Y/N)?**] (#does-the-target-ip-respond-to-icmp-echo-ping-requests-yn)
- [**Perform an Xmas scan on the first 999 ports of the target -- how many ports are shown to be open or filtered?**] (#perform-an-xmas-scan-on-the-first-999-ports-of-the-target-how-many-ports-are-shown-to-be-open-or-filtered)
- [**There is a reason given for this -- what is it?**] (#there-is-a-reason-given-for-this-what-is-it)
- [**Perform a TCP SYN scan on the first 5000 ports of the target -- how many ports are shown to be open?**] (#perform-a-tcp-syn-scan-on-the-first-5000-ports-of-the-target-how-many-ports-are-shown-to-be-open)
- [**Open Wireshark (see [Cryillic's](https://tryhackme.com/p/Cryillic) [Wireshark Room](https://tryhackme.com/room/wireshark) for instructions) and perform a TCP Connect scan against port 80 on the target, monitoring the results. Make sure you understand what's going on. Deploy the `ftp-anon` script against the box. Can Nmap login successfully to the FTP server on port 21? (Y/N)**] (#open-wireshark-see-cryillicshttpstryhackmecompcryillic-wireshark-roomhttpstryhackmecomroomwireshark-for-instructions-and-perform-a-tcp-connect-scan-against-port-80-on-the-target-monitoring-the-results-make-sure-you-understand-whats-going-on-deploy-the-ftp-anon-script-against-the-box-can-nmap-login-successfully-to-the-ftp-server-on-port-21-yn)

This writeup only included practical part of the room.  

<a id="does-the-target-ip-respond-to-icmp-echo-ping-requests-yn"></a>
...
<a id="perform-an-xmas-scan-on-the-first-999-ports-of-the-target-how-many-ports-are-shown-to-be-open-or-filtered"></a>
...
<a id="there-is-a-reason-given-for-this-what-is-it"></a>
## **There is a reason given for this -- what is it?**

**Note:** *The answer will be in your scan results. Think carefully about which switches to use -- and read the hint before asking for help!*

![image](/assets/images/screenshots/ss.jpeg)

Answer: no response  

<a id="perform-a-tcp-syn-scan-on-the-first-5000-ports-of-the-target-how-many-ports-are-shown-to-be-open"></a>
...
<a id="open-wireshark-see-cryillicshttpstryhackmecompcryillic-wireshark-roomhttpstryhackmecomroomwireshark-for-instructions-and-perform-a-tcp-connect-scan-against-port-80-on-the-target-monitoring-the-results-make-sure-you-understand-whats-going-on-deploy-the-ftp-anon-script-against-the-box-can-nmap-login-successfully-to-the-ftp-server-on-port-21-yn"></a>
