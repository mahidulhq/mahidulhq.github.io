...
- **Application Layer** (OSI: Application/Presentation/Session | TCP/IP: Application): You type “Hello” in WhatsApp, which uses an application protocol.

- **Transport Layer**: WhatsApp uses TCP to ensure your message is delivered correctly.
